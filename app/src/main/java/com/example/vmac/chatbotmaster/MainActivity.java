  ...
  protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (checkInternetConnection()) {
                    ...
                    Toast.makeText(getApplicationContext(), "Type something to interact or you use the mic", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void recordMessage() {
        if (listening != true) {
            ...
            btnRecord.setImageResource(R.mipmap.ic_launcher_mic_on);
            listening = true;
            ...
            try {
                ...
                btnRecord.setImageResource(R.mipmap.ic_launcher_mic_off);
                listening = false;
